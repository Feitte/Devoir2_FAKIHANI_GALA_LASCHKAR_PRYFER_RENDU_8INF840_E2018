========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet Exercice2_Hypergraph
========================================================================

AppWizard a créé cette application Exercice2_Hypergraph pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application Exercice2_Hypergraph.


Exercice2_Hypergraph.vcxproj
...
Exercice2_Hypergraph.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) Exercice2_Hypergraph.pch et un fichier de type précompilé nommé StdAfx.obj.
